...
#include "facial_landmarks_postprocess.hpp"
#include "common/math.hpp"
#include "common/tensors.hpp"
#include "post_processes_data/const_tensors.hpp"
...
xt::xarray<float> calc_bfm_params_xarray(NewHailoTensorPtr bfm_params)
{
...
xt::xarray<float> facial_landmark_postprocess(NewHailoTensorPtr bfm_params)
{
