...
# print(f"_new_hailo_tensor.nms_shape = {_new_hailo_tensor.nms_shape()}")
# print(f"_new_hailo_tensor.quant_info = {_new_hailo_tensor.quant_info()}")
# print(f"_new_hailo_tensor.format = {_new_hailo_tensor.format()}")
...
# print(f"_new_hailo_tensor.get_full_precision = {_new_hailo_tensor.get_full_precision()}")
