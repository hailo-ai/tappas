...
float YoloOutputLayer::get_class_conf(uint32_t prob_max)
{
...
std::pair<float, float> Yolov3OL::get_shape(uint32_t row, uint32_t col, uint32_t anchor, uint32_t image_width, uint32_t image_height)
{
    float w, h = 0.0f;
    uint32_t channel = _tensor->features() / NUM_ANCHORS * anchor + NUM_CENTERS;
...
std::pair<float, float> Yolov3OL::get_center(uint32_t row, uint32_t col, uint32_t anchor)
{
    float x, y = 0.0f;
    uint32_t channel = _tensor->features() / NUM_ANCHORS * anchor;
...
float Yolov4OL::get_confidence(uint32_t row, uint32_t col, uint32_t anchor)
{
...
uint32_t Yolov4OL::get_class_prob(uint32_t row, uint32_t col, uint32_t anchor, uint32_t class_id)
{
    uint32_t channel = _num_classes * anchor + class_id - 1;
    return _cls->get(row, col, channel);
}

float Yolov4OL::get_class_conf(uint32_t prob_max)
{
...
std::pair<float, float> Yolov4OL::get_center(uint32_t row, uint32_t col, uint32_t anchor)
{
    float x;
    float y;
    uint32_t channel = (_center->features() / NUM_ANCHORS) * anchor;
    if (_perform_sigmoid) {
...
std::pair<float, float> Yolov4OL::get_shape(uint32_t row, uint32_t col, uint32_t anchor, uint32_t image_width, uint32_t image_height)
{
    float w, h = 0.0f;
    uint32_t channel = (_scale->features() / NUM_ANCHORS) * anchor;
...
std::pair<float, float> TinyYolov4OL::get_center(uint32_t row, uint32_t col, uint32_t anchor)
{
    uint32_t channel = (_tensor->features() / NUM_ANCHORS) * anchor;
...
std::pair<float, float> TinyYolov4OL::get_shape(uint32_t row, uint32_t col, uint32_t anchor, uint32_t image_width, uint32_t image_height)
{
    float w, h = 0.0f;
    uint32_t channel = _tensor->features() / NUM_ANCHORS * anchor + NUM_CENTERS;
    w = expf(_tensor->get_full_precision(row, col, channel, _is_uint16)) * _anchors[anchor * 2] / image_width;
...
float YoloXOL::get_confidence(uint32_t row, uint32_t col, uint32_t anchor)
{
...
uint32_t YoloXOL::get_class_prob(uint32_t row, uint32_t col, uint32_t anchor, uint32_t class_id)
{
    return _cls->get(row, col, class_id - 1);
}

float YoloXOL::get_class_conf(uint32_t prob_max)
{
...
std::pair<float, float> YoloXOL::get_center(uint32_t row, uint32_t col, uint32_t anchor)
{
    float x, y = 0.0f;
...
std::pair<float, float> YoloXOL::get_shape(uint32_t row, uint32_t col, uint32_t anchor, uint32_t image_width, uint32_t image_height)
{
    float w, h = 0.0f;
