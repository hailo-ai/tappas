...
function init_variables() {
    ...
    readonly DEFAULT_VISION_CONFIG_FILE_PATH="$RESOURCES_DIR/configs/vision_config.json"
...
function print_usage() {
    ...
    echo "  --vision-config-file-path  Set the vision config file path (default $DEFAULT_VISION_CONFIG_FILE_PATH)"
    exit 0
}
