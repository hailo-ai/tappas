...
function main() {
    ...
    pipeline="$gst_top_command gst-launch-1.0 \
         ...
         hailonet hef-path=$DETECTION_HEF_PATH scheduling-algorithm=0 is-active=true nms-score-threshold=0.3 nms-iou-threshold=0.45 output-format-type=HAILO_FORMAT_TYPE_FLOAT32 force-writable=true ! \
         ...
         hailonet hef-path=$POSE_ESTIMATION_HEF_PATH scheduling-algorithm=0 is-active=true force-writable=true ! \
