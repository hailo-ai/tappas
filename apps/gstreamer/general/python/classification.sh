...
function init_variables() {
    ...
    readonly RESOURCES_DIR="$TAPPAS_WORKSPACE/apps/gstreamer/general/python/resources"
    readonly POSTPROCESS_DIR="$TAPPAS_WORKSPACE/apps/gstreamer/libs/post_processes/"
    readonly DEFAULT_POSTPROCESS_MODULE="$TAPPAS_WORKSPACE/apps/gstreamer/general/python/classification.py"
