...
function init_variables() {
    ...
    readonly DEFAULT_NETWORK_NAME="yolact_20_classes"
...
function print_usage() {
    ...
    echo "  --network NETWORK       Set network to use. choose from [yolact_20_classes, yolact1_6gf, yolact800mf],"
    echo "                          default network is yolact_20_classes"
