...
function init_variables() {
    ...
    readonly DEFAULT_VIDEO_SOURCE="$TAPPAS_WORKSPACE/apps/gstreamer/general/multinetworks_parallel/resources/instance_segmentation.mp4"
    readonly DEFAULT_HEF_PATH="$TAPPAS_WORKSPACE/apps/gstreamer/general/multinetworks_parallel/resources/joined_fast_depth_ssd_mobilenet_v1_no_alls.hef"
