...
function init_variables() {
    ...
    readonly RESOURCES_DIR="$TAPPAS_WORKSPACE/apps/gstreamer/general/multi_person_multi_camera_tracking/resources"
    readonly POSTPROCESS_DIR="$TAPPAS_WORKSPACE/apps/gstreamer/libs/post_processes/"
    readonly APPS_LIBS_DIR="$TAPPAS_WORKSPACE/apps/gstreamer/libs/apps/re_id/"
