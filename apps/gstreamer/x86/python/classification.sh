...
function init_variables() {
    ...
    readonly RESOURCES_DIR="$TAPPAS_WORKSPACE/apps/gstreamer/x86/python/resources"
    readonly POSTPROCESS_DIR="$TAPPAS_WORKSPACE/apps/gstreamer/x86/libs/"
    readonly DEFAULT_POSTPROCESS_MODULE="$TAPPAS_WORKSPACE/apps/gstreamer/x86/python/classification.py"
